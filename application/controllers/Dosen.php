...
class Dosen extends CI_Controller
{
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('nip', 'NIG', 'required|numeric|trim|min_length[8]|max_length[12]' . $u_nip);
		$this->form_validation->set_rules('nama_dosen', 'Nama Guru', 'required|trim|min_length[3]|max_length[50]');
	...
	public function create_user()
	{
		...
		if ($this->ion_auth->username_check($username)) {
			...
			$data = [
				'status'	=> true,
				'msg'	 => 'User berhasil dibuat. NIG digunakan sebagai password pada saat login.'
			];
		}
		$this->output_json($data);
	}
